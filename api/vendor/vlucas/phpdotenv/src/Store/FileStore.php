...
final class FileStore implements StoreInterface
{
    ...
    /**
     * Read the content of the env file(s).
     *
    ...
    {
        if ($this->filePaths === []) {
            throw new InvalidPathException('At least one env file path must be provided.');
        }
        ...
        throw new InvalidPathException(
            \sprintf('Unable to read any of the env file(s) at [%s].', \implode(', ', $this->filePaths))
        );
    }
}
